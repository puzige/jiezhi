...
1. 从 GitHub Releases 下载 `Jiezhi-v1.0.0.dmg`。
2. 打开 DMG，将“止界”拖入 Applications 文件夹。
3. v1.0.0 使用 ad-hoc 签名且**未经过 Apple notarization（公证）**。首次启动请在 Finder 中右键“止界”，选择“打开”，再在系统提示中确认。
...
```bash
DEVELOPER_DIR=/Applications/Xcode.app/Contents/Developer VERSION=1.0.0 ./scripts/build-release.sh
```
